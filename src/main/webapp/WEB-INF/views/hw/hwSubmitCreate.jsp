...
<body>
   ...
   <main>
      ...
      <form action="/hw/createSubmit.hw?list_seq=${hwView.list_seq}" method="post" id="submitForm" enctype="multipart/form-data">
         <div class="titleContainer">
            <input type="text" placeholder="제목을 입력하세요." name="title" id="inputTitle" required class="input_title" maxlength=80>
         </div>
         <div class="empty"></div>
   ...
   <script>
      document.getElementById("btn_cancel").onclick = function() {
         location.href = "/hw/hwSubmit.hw?list_seq=${hwView.list_seq}&cpage=1";
      }
