...
<body>
   ...
   <main>
      <div class="myModif_bigcontainer">
         ...
         <form action="lecModifyDone.users" id="modform" method="post"
...
function backtomod(){
   location.href="/users/mypageLec.users";
}
...
function setThumbnail(event) {
   ...
   function fn_modpw(){
      ...
      $(".input4").append("<input id=pw3 type=password>&nbsp<button type=button id=cancelModPw onclick=fn_cancelModPw()>취소</button><br><span class=pwChk></span>"); 
   }
