...
<body class="memberBody bg_gradation">
   ...
   <form id="signupform" action="/users/joinAccountDoneLec.users"
      method="post">
      <div class="bigcontainer">
         <div class="join3_container">

            <!-- ====================header====================-->
            <div class="join2_header">강사 회원 가입</div>
            <!-- ====================body====================-->
            <div class="join3_body">
               <div class="joinRow">
                  AUTH_ID : <input type="text" id="auth_id" name="auth_id"
                     required="required"> <input type="hidden"
                     id="authIdIsChecked" value="false">
                  <div></div>
                  <div></div>
                  <div class="join_width" id="authmsg"></div>
               </div>
               <div class="joinRow">
                  <span>ID :</span> <input type="text" id="us_id" name="us_id"
                     required="required">
               ...
               <div class="joinRow">
                  <input type="text" id="ctfNum" name="ctfNum" placeholder="인증번호 입력"
                     required="required" style="width: 40%"
                     onchange="noSpaceForm(this)">
                  <div></div>
                  <br><span id="comfNmtxt"></span>
                  <button type="button" id="ctfBtn" onclick="emailCtf()">번호
                     인증</button>
               </div>
            </div>
            ...
            <div class="join2_footer">
               <input class="memCom" type="button" id="done" value="회원가입"
                  onclick="signup()"> <input class="memCom" type="reset"
                  id="reset" value="다시입력"> <input class="memCom"
                  type="button" id="return" value="뒤로가기">
            </div>
         </div>
      </div>
   </form>

   <script src="/resources/js/joinAccountlec.js">
